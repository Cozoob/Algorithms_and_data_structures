...
# Algorytm Kruskala obliczajacy minimalne drzewo rozpinajace (MST)

from queue import PriorityQueue

# listy sasiedztwa VElogV
def Kruskala_v1(G):
...
def list_to_list(G):
    ...
    # dla kazdego u nalezacego do V to u: [(v, wartosc krawedzi {u,v}), ..]
G = [[(1, 1), (5, 7)],
     [(0, 1), (2, 12), (3, 4), (5, 8)],
     [(1, 12), (3, 6), (5, 3)],
     [(1, 4), (2, 6), (4, 5)],
